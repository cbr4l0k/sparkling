...
pub struct ReopenCardUseCase {
    card_repository: Arc<dyn CardRepository>,
    event_repository: Arc<dyn EventRepository>,
}

pub struct ReopenCardInput {
    pub account_id: FizzyId,
    pub user_id: FizzyId,
    pub card_number: i64,
}

impl ReopenCardUseCase {
    pub fn new(
        card_repository: Arc<dyn CardRepository>,
        event_repository: Arc<dyn EventRepository>,
    ) -> Self {
    ...
    pub async fn execute(&self, input: ReopenCardInput) -> Result<(), ApplicationError> {
        ...
        self.card_repository
            .reopen(&input.account_id, &card.id)
            .await
            .map_err(ApplicationError::DomainError)?;
        ...
        let _ = self.event_repository
            .create_event(&input.account_id, CreateEventInput {
                ...
                action: event_actions::CARD_REOPENED.to_string(),
